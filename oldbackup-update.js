        ...
        for (var j = 0; j < allPages.length-1; j++) {
            ...
            if (eachPage) {
                ...
                for (var i = 0; i < allList.length; i++) {
                    ...
                    // document.getElementById('#ctl00_siteContent_widgetLayout_rptWidgets_ctl03_widgetContainer_ctl00_pgrList_pagingLinksRepeater_ctl01_pageSelector').click();
                }
                document.getElementById('ctl00_siteContent_widgetLayout_rptWidgets_ctl03_widgetContainer_ctl00_pgrList_nextPageLink').click();
            }
        }
        return allJobs;
    });
